...
public class FavoriteFactory extends DBEntityFactory {
    ...
    public DBEntity generateEntity(@NonNull Cursor resource) {
        ...
        if(SkillFactory.FACTORY_ID.equalsIgnoreCase(factoryId)) {
            ...
            entity = new Weapon();
        } else if(ArmorFactory.FACTORY_ID.equalsIgnoreCase(factoryId)) {
            entity = new Armor();
        } else if(EquipmentFactory.FACTORY_ID.equalsIgnoreCase(factoryId)) {
            entity = new Equipment();
        } else if(MagicItemFactory.FACTORY_ID.equalsIgnoreCase(factoryId)) {
            entity = new MagicItem();
        } else if(TraitFactory.FACTORY_ID.equalsIgnoreCase(factoryId)) {
            entity = new Trait();
        } else {
            return null;
        }
